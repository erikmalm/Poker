# Poker
 A poker game in java simulating poker games.
 The class Deck is the primary engine of the game. From this class you can deal new cards
 and it keeps track of which cards that have been dealt previously. This should work regardless if
 the card is dealt to a player, a computer opponent or to the table (as in texas holdem), opening
